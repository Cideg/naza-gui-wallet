...
//    , m_encryptionStatusIconLabel(new QLabel(this))
    ...
    , m_nazadConnectionLabel(new QLabel(this))
...
//    m_encryptionStatusIconLabel->setObjectName("m_encryptionStatusIconLabel");
    ...
    addPermanentWidget(m_nazadConnectionLabel);
...
void WalletStatusBar::setWalletModel(WalletModel* model)
{
    ...
    stateMapper_->addMapping(m_nazadConnectionLabel, WalletModel::COLUMN_LOWER_LEVEL_ERROR, "text");
