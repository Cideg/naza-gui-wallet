...
constexpr quint16 DEFAULT_LOCAL_RPC_PORT = 18642;
constexpr char LOCAL_HOST[] = "127.0.0.1";

#if defined(Q_OS_LINUX)
constexpr char DEFAULT_WORK_DIR[] = ".naza";
#endif

const constexpr char* DEFAULT_MINING_POOLS[] = { "104.168.144.234:3333" };
...
Settings::Settings()
{
    ...
    const QString jsonFile = getDefaultWorkDir().absoluteFilePath("naza-gui.config");
